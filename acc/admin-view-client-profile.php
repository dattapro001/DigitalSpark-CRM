...
<h5 class="mx-3 text-light mt-2" style="font-family: 'Timmana'">Client profile</h5>
</header>
  <div class="row">
    <div class="col-lg-12">
    <div class="card mt-1 ket" style="font-family: 'Timmana'; height: 600px; width: 1100px; margin-left: 110px; border-radius: 20px; background-color: rgb(0,0,0,0.8); border: 4px solid rgb(254,190,16);  overflow-y: auto;">
 ...
 <!-- col-md-6 -->
      ...
      <div class="col-md-6">
             ...
             <textarea class="form-control text-light ket" id="txt" type="text" name="text" style="width: 473px; height:170px; background-color: rgb(0,0,0,0.8); border-color: rgb(254,190,16);" readonly><?php echo $arrayData['bio'] ?></textarea>
             </div>
      </div>
      ...
      <div class="col-md-12 mt-4">
        <div class="card text-light" style="margin-left: 195px; height: 170px; width: 700px; background-color: rgb(0,0,0,0.8); border-color: rgb(254,190,16);" readonly>
          ...
          <div class="col-md-6 mt-4 mx-4 " style="width: 370px;">
            ...
            <label class="mt-3 text-warning">Phone:  </label>     <?php echo $arrayData['phone'] ?><br>
            <label class="mt-3 text-warning">Country:  </label>   <?php echo $arrayData['country'] ?>
          </div>

          <div class="col-md-6 mt-5 mx-5 " style="width:200px">
          <label class="text-warning">Join Date :  </label>     <?php echo $arrayData['join_date'] ?><br>
      ...
      <div class="text-light mx-2 col-md-12 text-center mt-5" style="position: relative;">
                  <hr class="my-2 bg-light" style="">
                  <span style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); font-size: 20px;">Interest</span>
      </div>
