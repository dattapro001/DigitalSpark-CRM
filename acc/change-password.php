...
if (isset($_GET['reset'])) {
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM details WHERE code='{$_GET['reset']}'")) > 0) {
        if (isset($_POST['submit'])) {
            $password =  $_POST['c_pass'];
            $confirm_password = $_POST['c_conpass'];

            if ($password === $confirm_password) {
                $query = mysqli_query($conn, "UPDATE details SET password='{$password}', code='' WHERE code='{$_GET['reset']}'");

                if ($query) {
                    echo "<script> alert('Password change Sucessfully. Login Now!!') </script>"; 
    ...
    <div class="container-fluid">
        <div class="row justify-content-center mt-4">
            ...
            <form action="" method="post">
                    <img src="images/client-change-password.jpg"> 
                    <div class="mb-3 ">
                    <h2 style="font-family:'Timmana';">Change Password</h2>
                    <p style="font-family:'Timmana'; font-size: 12px;"> 
                    <?php echo $msg; ?>
                    </p>
                    </div>
                       <div class="input2">
                        <h6><b>Password:</b></h6> 
                         <input type="password" class="pass" id="c_pass"  name="c_pass" placeholder="Enter Your Email" value=""
                        ...
                        <div class="button">
                        <input name="submit" class="btn btn-outline-primary stop" id="submit" value="Change" type="submit" style="font-family:'Timmana';"/>
                         </div>
                       <div class="login">
                        <p style="font-family:'Timmana';">Back To! <a href="client-login.php" style="font-family:'Timmana';">Login</a>.</p>
                       </div> 
                    </form>
                </div>
           </div>
