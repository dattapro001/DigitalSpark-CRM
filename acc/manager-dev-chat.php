<?php 
 ...
 $message = "";
   ...
   if (isset($_POST['change1'])) {
    ...
    window.location.href = "manager-dev-chat.php?user_id='.$user_id.'";</script>';
  ...
  <div class="container-fluid">
    ...
    <section class="chat-area">
      <header>
          <?php
          $user_id = mysqli_real_escape_string($conn, $_GET['user_id']);
          $sql = mysqli_query($conn, "SELECT * FROM developer WHERE unique_id = '{$user_id}'");
          if(mysqli_num_rows($sql) > 0){
            $data = mysqli_fetch_assoc($sql);
          }
        ?>

        <a href="manager.php" class="back-icon"><ion-icon class="btn btn-outline-light" name="arrow-back"></ion-icon></a>
        <img src="uploaded_img/<?php echo $data['d_profile']; ?>" alt="">
        <div class="details">
          ...
          <li><b class="text-light" style="margin-left: 35px">Change Theme</b></li>
          <form method="post" enctype="multipart/form-data">
          <li>
          <input type="text" value="chat-1" name="img-1" style="display:none;"> 
          <input class="mt-2 mx-5 btn btn-outline-light" type="submit" value="Theme-1" name="change1">
          </li>
          <li>
          <input type="text" value="chat-2" name="img-2" style="display:none;"> 
          <input class="mt-1 mx-5 btn btn-outline-light"  type="submit" value="Theme-2" name="change2">
          </li>
          <li>
          <input type="text" value="chat-3" name="img-3" style="display:none;"> 
          <input class=" mt-1 mx-5 btn btn-outline-light"  type="submit" value="Theme-3" name="change3">
          </li>
          <li>
          <input type="text" value="chat-4" name="img-4" style="display:none;"> 
          <input class="mt-1 mx-5 btn btn-outline-light"  type="submit" value="Theme-4" name="change4">
          </li>
          <li>
          <input type="text" value="chat-5" name="img-5" style="display:none;"> 
          <input class="mt-1 mx-5 btn btn-outline-light"  type="submit" value="Theme-5" name="change5">
          </li>
          <li class="mt-3"><a href="manager-dev-profile.php?user_id=<?php echo $user_id; ?>" class="btn btn-outline-light" style="text-decoration:none; margin-left: 30px"><b class="">Check Profile</b></a></li>
          </form>
          </ul>
          </div>
      ...
      <div class="chat-box">
       ...
       <form method="post" id="messageFrom" class="typing-area">
        ...
        <input type="text" name="message" class="input-field" placeholder="Type a message here..." autocomplete="off">
         <button type="submit" name="send_msg" value="" class="button btn btn-outline-light"><ion-icon name="send"></ion-icon></button>
      </form>
      </div>
    </div>
  </div>
