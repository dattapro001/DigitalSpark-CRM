 ...
 $message = "";
   ...
   if (isset($_POST['change1'])) {
    ...
    $result5 = mysqli_query($conn, $sql5);
      ...
      window.location.href = "client-admin-chat.php?user_id='.$arrayData1['unique_id'].'";
      </script>';
  }
  ...
  <div class="container-fluid">
    ...
    <section class="chat-area">
      <header>
        ...
        <a href="client-page.php" class="back-icon"><ion-icon class="btn btn-outline-warning" name="arrow-back"></ion-icon></a>
