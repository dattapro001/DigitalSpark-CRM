    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM details WHERE email='{$email}'")) > 0) {
            ...
            if ($password === $confirm_password) {
                ...
                $sql = "INSERT INTO details (name, email, password, unique_id, active_status, code, image) VALUES ('{$name}', '{$email}', '{$password}', '{$ran_id}', '{$status}', '{$code}', '{$image}')";
                $result = mysqli_query($conn, $sql);
                
                // Inter Date AUtomatically
                $date = "INSERT INTO details (date) VALUES (DATE(CURRENT_TIMESTAMP));";
    ...
    <div class="container-fluid">
        <div class="row justify-content-center mt-4">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                    <img src="images/client-register.jpg"> 
                    <div class="mb-3">
                    <h2>Register</h2>
                    <p> 
                    <?php echo $msg; ?>
