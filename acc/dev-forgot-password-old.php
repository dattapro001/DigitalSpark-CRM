    ...
    <div class="container-fluid">
        <div class="row justify-content-center mt-4">
            ...
            <form action="" method="post">
                    <img src="images/dev-forgot-password.jpg"> 
                    <div class="mb-3">
                    ...
                    <?php echo $msg; ?>
                       ...
                       <div class="input2">
                        <h6><b>Email:</b></h6> 
                         <input type="email" class="email" id="l_email"  name="f_email" placeholder="Enter Your Email" value="<?php if (isset($_POST['submit'])) { echo $email; } ?>"
