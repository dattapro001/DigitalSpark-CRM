      ...
      <div class="container-fluid">
        <div class="col-md-6">
            <div class="card">
                <div class="row">
                    <div class="col-md-6">
                    <h3 class="mx-2 text-light mt-2" style="font-family: 'Timmana'">Forgot-password</h3>
                          <img src="images/client-forgot.png" style="height: 350px; width: 400px; margin-top:-40px; margin-left:-10px;">
                    </div>
                    <div class="col-md-6">
                       ...
                       <p> 
                        ...
                        <form method="post" style="margin-top: -10px; position:fixed;">
                            <div class="input mt-5">
                                <label class="" style="font-family: 'Timmana'">Email</label><br>
                            ...
                            <div class="button mt-3">
                                ...
                                style="background-color: rgb(255, 255, 255); font-family: 'Timmana'" value="Send Resend Link" type="submit"/>
                            </div>
                            <div class="login mt-3">
                                <p class="text-light" style="font-family: 'Timmana'">Back To! <a href="client-login.php" class="text-light" style="margin-left:px;
                                 text-decoration: none; font-family: 'Timmana'">login</a>.</p>
                            </div>
                        </form>
                     </div>
                  </div>
