<?php 
 ...
 $message = "";
   ...
   if (isset($_POST['change1'])) {
    ...
    echo '<script>alert("Background Changes");</script>';
  ...
  <div class="container-fluid">
    ...
    <section class="chat-area">
      <header>
        ...
        <a href="admin-page.php" class="back-icon"><ion-icon class="btn btn-outline-light" name="arrow-back"></ion-icon></a>
        ...
        <div class="details">
          ...
          <li class="mt-3"><a href="admin-dev-profile.php?user_id=<?php echo $user_id?>" class="btn btn-outline-light" style="text-decoration:none; margin-left: 30px"><b class="">Check Profile</b></a></li>
          </form>
          </ul>
          </div>
