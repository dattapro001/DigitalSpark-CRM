<?php
    ...
    if (isset($_POST['submit'])) {
        ...
        if (mysqli_num_rows($result) === 1) {
            ...
            $status = "Active";
            $sql2 = mysqli_query($conn, "UPDATE manager SET active_status = '{$status}' WHERE unique_id = {$row['unique_id']}");
...
<head>
    ...
    <style>
        body {
            margin: 0;
            padding: 0;
            background: url('images/dev-log-bg.jpg') no-repeat center center fixed; 
        ...
        .input input{
            border:none;
            outline:none;
            border-bottom: 2px solid rgba(233, 233, 12, 0.986);
            width: 250px;
    ...
    <div class="container-fluid">
        <div class="col-md-6">
            <div class="card">
                <div class="row">
                    <div class="col-md-6">
                    <h3 class="mx-3 text-light" style="font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;">Manager Login</h3>
                          <img src="images/dev-log-1.png" style="height: 350px; margin-top:-40px;" height="320px">
                    </div>
                    <div class="col-md-6">
                       ...
                       <p> 
                        ...
                        <form method="post" style="margin-top: -10px; position:fixed;">
                            ...
                            <div class="input mt-2" style="">
                                <h6><b> <a href="dev-forgot-password.php" style="text-decoration: none;">Forgot Password</a></b></h6>
                            </div>
                            <div class="button mt-3">
                                <input name="submit" class="btn btn-outline-primary text-dark stop" id="submit" value="Login" type="submit"
                                style="background-color: rgb(233, 233, 12, 0.9); width: 90px;"/>
                            </div>
                            <div class="login mt-2">
                                <p class="text-light"><b>Don't Have Account? </b><a href="dev-register.php" class=""><b>Register</b></a>.</p>
                            </div>
                        </form>
                     </div>
                  </div>
        ...
        <script>
          ...
          moveBtn.style.background = "rgb(233, 233, 12, 0.6)";
               }
           else{
