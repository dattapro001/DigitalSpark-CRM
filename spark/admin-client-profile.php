...
<a href="admin-client-chat.php?user_id=<?php echo $user_id ?>" style="text-decoration: none;"> 
<h6 class=" mx-4 text-warning" style="font-family: 'Salsa'; margin-top: 5px; "><b>CRM</b></h6>
</a>
<h5 class="mx-3 text-light"><b>Client profile</b></h5>
</header>
  <div class="row">
    <div class="col-lg-12">
    <div class="card mt-1 ket" style="height: 600px; width: 988px; margin-left: 180px; border-radius: 20px; background-color: #34495e; border: 2px solid white;   overflow-y: auto;">
 ...
 <!-- col-md-6 -->
      ...
      <div class="col-md-6 mt-2">
             ...
             <div class="text-light mx-1 mt-2">
              <textarea class="form-control mt-4 text-light ket" id="txt" type="text" name="skill_1" style="height: 80px ; background-color: rgb(0,0,0,0.8); border-color: white;" readonly><?php echo $arrayData['interest1'] ?></textarea>
             </div>

              <div class="text-light mx-1 mt-4">
              <textarea class="form-control mt-2 text-light ket" id="txt" type="text" name="skill_2" style="height: 80px ; background-color: rgb(0,0,0,0.8); border-color: white;" readonly><?php echo $arrayData['interest2'] ?></textarea>
             </div>
      </div>
      ...
      <header class="text-light" style="text-decoration: underline; opacity: 0;"><h5> What I Do </h5></header>
               ...
               <div class="text-light mx-1">
                <textarea class="form-control mt-2 text-light ket" id="txt" type="text" name="skill_3" style="height: 80px ; background-color: rgb(0,0,0,0.8); border-color: white;" readonly><?php echo $arrayData['interest3'] ?></textarea>
               </div>

                <div class="text-light mx-1 mt-4">
                <textarea class="form-control mt-2 text-light ket" id="txt" type="text" name="skill_4" style="height: 80px ; background-color: rgb(0,0,0,0.8); border-color: white;" readonly></textarea>
               </div>
        </div>
