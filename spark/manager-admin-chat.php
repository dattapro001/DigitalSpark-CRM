   ...
   if (isset($_POST['change1'])) {
    ...
    $result5 = mysqli_query($conn, $sql5);
      ...
      echo '<script>alert("Background Changes");
           window.location.href = "manager-admin-chat.php?user_id='.$arrayData1['unique_id'].'";
           </script>';
  }
  ...
  <div class="container-fluid">
    ...
    <section class="chat-area">
      <header>
          <?php
          $user_id = mysqli_real_escape_string($conn, $_GET['user_id']);
          $sql = mysqli_query($conn, "SELECT * FROM admin WHERE 1");
      ...
      <div class="chat-box">
       ...
       <form method="post" id="messageFrom" class="typing-area">
        ...
        <button type="submit" name="send_msg" value="" class="btn btn-outline-light"><ion-icon name="send"></ion-icon></button>
      </form>
      </div>
    </div>
  </div>
