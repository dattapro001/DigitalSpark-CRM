               ...
               <div class="status-dot d-flex" style="position: relative; margin-right: -5px;">
                  <div class="function" style="position: absolute; margin-left:-650px;">
                   ...
                   <div class="" style="  margin-left:-175px; font-size: 17px;">
                       <p class="justify-content-center align-item-center text-light" style="">'. $row['date'].'</p>
                   </div>
                   </div>
                   <div class="">
                   <p class="date" style="padding: 0px 20px; color: white; font-size: 17px; margin-right: 40px;">'. $row['suspend_date'] .'</p>
                   </div>
                   <div class="" style="">
