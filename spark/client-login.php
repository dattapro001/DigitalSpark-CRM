...
<body>
    <img src="img/client-bg.png" style="z-index: -1; position: fixed; height: 750px; width: 700px;">
    <header></header>
    
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <img src="img/login.svg" class="" style="width: 500px; height: 400px; margin-left: 250px; z-index: 0; margin-top: 150px;">
            </div>
            
            <div class="col-md-6">
                <form method="post">
                    <div class="container-fluid">
                    <div class="msg mt-5" style="position: relative; margin-left: 200px; font-family: 'Timmana'">
                        <?php echo $msg ?>
                        </div>
                        <img src="img/avatar.svg" style="width: 100px; height: 100px; margin-left: 300px; margin-top: 70px;">
                        <p class=" mt-3" style="margin-left: 275px; font-size: 18px; font-family: 'Timmana'"><b>Client </b> <b style="color: rgb(6, 151, 79);">Login</b> <b> / </b><a href="client-register.php" class="regi text-dark" style="text-decoration: none; font-size: 18px;"><b>Register</b></a></p>
                        
                        <div class="input mt-5" style="margin-left: 220px;">
                            <div class="email">
                                <label><i class="fa fa-user d-flex " style="position: absolute; margin-top: -30px; color: rgb(0, 255, 128);"><span class="mx-2 mt-2 text-dark" style="font-family: 'Timmana'">Email</span></i></label>
                                <input type="email" class="email" name="l_email" style="position: relative;">
                            </div>
                            <div class="pass mt-5">
                                <label><i class="fa fa-lock d-flex" style="position: absolute; margin-top: -30px; color: rgb(0, 255, 128);"><span class="mx-2 mt-2 text-dark" style="font-family: 'Timmana'">Password</span></i></label>
                                <input type="password" class="pass" name="l_password" style="position: relative;"><br>
                                <a href="forgot-password.php" class="text-dark" style="text-decoration: none; margin-left: 150px; font-size: 16px; font-family: 'Timmana'"><b>Forget Password</b></a>
                            </div>
