...
<body style="background-color: black">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <img src="img/mana.svg" class="" style="width: 500px; height: 400px; margin-left: 200px; z-index: 0; margin-top: 150px;">
            </div>
            ...
            <div class="col-md-6">
                <form method="post">
                    ...
                    <div class="msg mt-5" style="position: relative; margin-left: 200px;">
                        ...
                        <p class=" mt-3 text-light" style="margin-left: 300px; font-size: 18px; font-family: 'Timmana'">Manager Login</p>
                        ...
                        <div class="input mt-5" style="margin-left: 220px;">
                            <div class="email">
                                ...
                                <input type="email" class="email text-light" name="l_email" style="position: relative;">
                            </div>
                            <div class="pass mt-5">
                                ...
                                <input type="password" class="pass text-light" name="l_password" style="position: relative;">
                            </div>
