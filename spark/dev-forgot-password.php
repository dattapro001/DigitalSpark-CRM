...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM developer WHERE email='{$email}'")) > 0) {
        $query = mysqli_query($conn, "UPDATE developer SET d_code='{$code}' WHERE email='{$email}'");
                       ...
                       <p style="font-family:'Timmana';"> 
                        ...
                        <form method="post" style="margin-top: -10px; position:fixed;">
                            ...
                            <div class="login mt-3">
                                <p class="text-light">Back To! <a href="dev-login.php" class="text-light" style="margin-left:px;
