...
<body>
    ...
    <div class="" style=" z-index: 3; width: 650px; margin-left: 650px; height: 30px; font-family: 'Timmana'"><b><?php echo $msg ?></b></div>
            ...
            <div class="col-md-6">
                <form method="post" enctype="multipart/form-data">
                    <div class="container-fluid" style="margin-left: -690px; margin-top: -150px; position: fixed">
                        ...
                        <p class=" mt-3" style="margin-left: 265px; font-size: 18px; font-family: 'Timmana'"><b>Client </b> <a href="client-login.php" style="text-decoration: none;" class="log text-dark"><b>Login</b></a> <b> / </b><a href="" class="text-dark" style="text-decoration: none; font-size: 18px;"><b style="color: rgb(6, 151, 79);">Register</b></a></p>
                        
                        <div class="input mt-2" style="margin-left: 220px;">

                        <div class="">
                           <label><i class="fa fa-user" style="position:absolute; margin-top: 0px; color: rgb(0, 255, 128);"><span class="mx-2 mt-2 text-dark" style="font-size: 16px; font-family: 'Timmana'">Name</space></i></label><br>
                           ...
                           <div class="mt-2">
                            ...
                            <div class="mt-2">
                                ...
                                <div class="mt-2">
                                    ...
                                    <div class="mt-2">
                                        <label><i class="fa fa-file-text" style="position:absolute; margin-top: 0px; color: rgb(0, 255, 128);"><span class="mx-2 text-dark" style="font-size: 16px; font-family: 'Timmana'">Profile-Image</span></i></label><br>
